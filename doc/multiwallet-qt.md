...
In order to support loading of multiple wallets in beacon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is beacon.cpp.
...
Changes to beacon.cpp
----------------------
beacon.cpp is the entry point into beacon-qt, and as such, will require some minor modifications to provide hooks for
