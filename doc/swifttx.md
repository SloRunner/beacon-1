...
This mechanism has been integrated into Bitcore-Node-Beacon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Beacon-Project/insight-api-beacon#web-socket-api](https://github.com/Beacon-Project/insight-api-beacon#web-socket-api) 
* API: [https://github.com/Beacon-Project/insight-api-beacon#swifttx-transactions](https://github.com/Beacon-Project/insight-api-beacon#swifttx-transactions) 
...
By default, the Beacon Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Beacon Core daemon:
