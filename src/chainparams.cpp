...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
        (0, uint256("0x675e179c869287ad9809539a7cc019ba4654def47904d2d260d191682135d7ab"))
        (5555, uint256("0xff927e88f60c94bcf5d0098e6fb8c6894893ae67565b688897852965011070fb"))
        (51985, uint256("0x9e432725fde1535b77d768601c509f6ff365cb539b822a140588099471568f19"))
        (64045, uint256("0xeb6d42c79fa319fbe44c398613d633277c43dbf0efdbdbef7c758f20e2e1b176"))
        (73544, uint256("0xeb6d42c79fa319fbe44c398613d633277c43dbf0efdbdbef7c758f20e2e1b176"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1571582967, // * UNIX timestamp of last checkpoint block
    153283,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "When the Internet first came, I thought it was just the beacon of freedom - 2019";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1565962890;
        genesis.nBits = 504365040;
        genesis.nNonce = 703787;

        hashGenesisBlock = genesis.GetHash();
        //printf("%s %s\n",hashGenesisBlock.ToString().c_str(), genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x675e179c869287ad9809539a7cc019ba4654def47904d2d260d191682135d7ab"));
        assert(genesis.hashMerkleRoot == uint256("0xeb94d2486fcb66035af657a55b9e0dccba72d5232dcf130f96d5ebdaa18a0651"));

        vSeeds.push_back(CDNSSeedData("1", "136.244.80.206"));
        vSeeds.push_back(CDNSSeedData("2", "144.202.104.105"));
        vSeeds.push_back(CDNSSeedData("3", "95.179.207.150"));
        vSeeds.push_back(CDNSSeedData("4", "45.32.176.163"));
        vSeeds.push_back(CDNSSeedData("5", "45.63.99.162"));
        vSeeds.push_back(CDNSSeedData("6", "45.63.101.53"));
        ...
        strObfuscationPoolDummyAddress = "bUwUZdUZcc5hXiEWSVYHaxsQqj7xuU7V7R";
