                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Beacon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Beacon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and beacon: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Beacon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Beacon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Beacon"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Beacon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Beacon addresses"));
    ...
    openAction->setStatusTip(tr("Open a Beacon: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Beacon Core help message to get a list with possible Beacon command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Beacon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Beacon network", "", count));
}
...
{
    QString strTitle = tr("Beacon Core"); // default title
