...
const QString BITCOIN_IPC_PREFIX("beacon:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/beacon-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/beacon-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/beacon-paymentrequest";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // beacon: URI
    {
        ...
        } else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient)) {
                ...
                emit message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Beacon address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
