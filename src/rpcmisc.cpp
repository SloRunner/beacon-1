...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total beacon balance of the wallet\n"
            "  \"obfuscation_balance\": xxxxxx, (numeric) the anonymized beacon balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in beacon/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in beacon/kb\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Beacon address and we have full public key:
