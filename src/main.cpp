...
int64_t GetBlockValue(int nHeight)
{
    ...
    }   else if (nHeight <= 17200 && nHeight > 0) {
        nSubsidy = 1 * COIN;
    }   else if (nHeight <= 51600 && nHeight > 17200) {
        nSubsidy = 8 * COIN;
    }   else if (nHeight <= 120400 && nHeight > 51600) {
        nSubsidy = 6 * COIN;
    }   else if (nHeight <= 224000 && nHeight > 120400) {
        nSubsidy = 5 * COIN;
    }   else if (nHeight <= 674000 && nHeight > 224000) {
        nSubsidy = 4 * COIN;
    }   else if (nHeight <= 1124000 && nHeight > 674000) {
        nSubsidy = 3 * COIN;
    }   else if (nHeight <= 1574000 && nHeight > 1124000) {
        nSubsidy = 2 * COIN;
    }   else {
        nSubsidy = 1 * COIN;
    }
...
int ActiveProtocol()
{
    if (IsSporkActive(SPORK_20_NEW_PROTOCOL_ENFORCEMENT))
